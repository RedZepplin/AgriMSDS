...
//Chemical Tables
  ...
  Product: list({
    ...
    fields: {
      tradeName: text(),
      activeIngredient: relationship({
        ref: 'ProductIngredient',
        many: true
      }),
      regCodes: relationship({
        ref: 'RegCode.product',
        many: true
      }),
      regCo: relationship({
  ...
  ChemicalClass: list({
    ...
    fields:{
      ...
      classCode: text(),
      activeIngredients: relationship({ref: 'ActiveIngredientRegister.chemClass', many: true}),
    },
    ui: {
  ...
  ActiveIngredientRegister: list({
    ...
    fields:{
      ...
      chemClass: relationship({ref: 'ChemicalClass.activeIngredients', many: false}),
      notes: document({
        links: true,
        layouts: [
          [1, 1],
  ...
  ProductIngredient: list({
    access: allowAll,
    fields:{
        ingredient: relationship({ref: 'ActiveIngredientRegister', many: false}),
